	...
	public function enqueue_assets( $hook_suffix ) {
		...
		wp_localize_script(
			...
			array(
				...
				'manualCustomerLookupNonce' => wp_create_nonce( 'crpcrm_manual_request_customer_lookup' ),
				'manualCustomerSaveNonce'   => wp_create_nonce( 'crpcrm_manual_request_customer_save' ),
				...
				'manualCustomerLoading' => 'در حال جستجوی مشتری...',
				'manualCustomerLookupError' => 'جستجوی مشتری انجام نشد.',
				'manualCustomerSaveLoading' => 'در حال ذخیره اطلاعات مشتری...',
				'manualCustomerSaveError' => 'ذخیره اطلاعات مشتری انجام نشد.',
				'manualCustomerCreateRequired' => 'برای ثبت درخواست ابتدا باید مشتری ایجاد شود.',
				'productSearchMin'     => 2,
