...
class CRPCRM_Reports_Repository {
	...
	public function get_request_details( $filters, $pagination ) {
		...
		$sql    = "SELECT r.id, r.request_code, r.customer_id, r.request_type, r.request_summary, r.request_source, r.request_campaign, r.request_content, r.status, r.owner_id, r.last_activity_at, r.created_at, c.full_name AS customer_name, c.phone AS customer_phone
