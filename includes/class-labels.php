	...
	public static function get_activity_label( $activity_type ) {
		return self::from_map(
			...
			array(
				...
				'manual_customer_created'                   => 'ساخت مشتری',
				...
				'request_transferred'                       => 'انتقال درخواست',
				'in_progress'                               => 'درحال پیگیری',
				'followed_up'                               => 'پیگیری شد',
				'follow_up_scheduled'                       => 'تنظیم پیگیری بعدی',
				'customer_reply'                            => 'پاسخ مشتری',
				'staff_reply'                               => 'پاسخ کارشناس',
				'manager_reply'                             => 'پاسخ مدیر',
