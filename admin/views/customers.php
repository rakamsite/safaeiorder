...
<div class="wrap crpcrm-admin-wrap crpcrm-customers-admin" dir="rtl">
			...
			<?php else : ?>
				<?php foreach ( $customers as $item ) : ?>
					<tr>
						...
						<td><?php echo esc_html( $item['last_request_code'] ? $item['last_request_code'] . ' - ' . $item['last_request_at'] : '—' ); ?></td>
	...
	<?php elseif ( 'profile' === $mode ) : ?>
		...
		<div class="crpcrm-detail-grid">
			<div class="crpcrm-card"><h2><?php echo esc_html( 'اطلاعات پایه مشتری' ); ?></h2><dl><dt><?php echo esc_html( 'نام و نام خانوادگی' ); ?></dt><dd><?php echo esc_html( crpcrm_display_value( $customer['full_name'] ) ); ?></dd><dt><?php echo esc_html( 'شماره موبایل' ); ?></dt><dd><?php echo esc_html( crpcrm_display_value( $customer['phone'] ? $customer['phone'] : $customer['phone_normalized'] ) ); ?></dd><dt><?php echo esc_html( 'استان' ); ?></dt><dd><?php echo esc_html( crpcrm_display_value( $customer['province'] ) ); ?></dd><dt><?php echo esc_html( 'شهر' ); ?></dt><dd><?php echo esc_html( crpcrm_display_value( $customer['city'] ) ); ?></dd><dt><?php echo esc_html( 'وضعیت تکمیل پروفایل' ); ?></dt><dd><span class="crpcrm-badge crpcrm-status-badge"><?php echo esc_html( ! empty( $customer['profile_completed'] ) ? 'تکمیل شده' : 'ناقص' ); ?></span></dd><dt><?php echo esc_html( 'تاریخ ایجاد پروفایل' ); ?></dt><dd><?php echo esc_html( crpcrm_display_value( $customer['created_at'] ) ); ?></dd><dt><?php echo esc_html( 'آخرین بروزرسانی پروفایل' ); ?></dt><dd><?php echo esc_html( crpcrm_display_value( $customer['updated_at'] ) ); ?></dd></dl></div>
			<div class="crpcrm-card"><h2><?php echo esc_html( 'اولین ورود' ); ?></h2><dl><dt><?php echo esc_html( 'منبع' ); ?></dt><dd><?php echo esc_html( CRPCRM_Helpers::get_source_label( $customer['first_source'] ) ); ?></dd><dt><?php echo esc_html( 'مدیوم' ); ?></dt><dd><?php echo esc_html( CRPCRM_Helpers::get_medium_label( $customer['first_medium'] ) ); ?></dd><dt><?php echo esc_html( 'کمپین' ); ?></dt><dd><?php echo esc_html( crpcrm_display_value( $customer['first_campaign'] ) ); ?></dd><dt><?php echo esc_html( 'محتوا' ); ?></dt><dd><?php echo esc_html( crpcrm_display_value( $customer['first_content'] ) ); ?></dd><dt><?php echo esc_html( 'کلمه کلیدی' ); ?></dt><dd><?php echo esc_html( crpcrm_display_value( $customer['first_term'] ) ); ?></dd><dt><?php echo esc_html( 'صفحه ورود' ); ?></dt><dd><?php echo esc_html( crpcrm_display_value( $customer['first_landing_page'] ) ); ?></dd><dt><?php echo esc_html( 'ارجاع‌دهنده' ); ?></dt><dd><?php echo esc_html( crpcrm_display_value( $customer['first_referrer'] ) ); ?></dd><dt><?php echo esc_html( 'تاریخ اولین ورود' ); ?></dt><dd><?php echo esc_html( crpcrm_display_value( $customer['first_seen_at'] ) ); ?></dd></dl></div>
			<div class="crpcrm-card"><h2><?php echo esc_html( 'آخرین ورود' ); ?></h2><dl><dt><?php echo esc_html( 'منبع' ); ?></dt><dd><?php echo esc_html( CRPCRM_Helpers::get_source_label( $customer['last_source'] ) ); ?></dd><dt><?php echo esc_html( 'مدیوم' ); ?></dt><dd><?php echo esc_html( CRPCRM_Helpers::get_medium_label( $customer['last_medium'] ) ); ?></dd><dt><?php echo esc_html( 'کمپین' ); ?></dt><dd><?php echo esc_html( crpcrm_display_value( $customer['last_campaign'] ) ); ?></dd><dt><?php echo esc_html( 'محتوا' ); ?></dt><dd><?php echo esc_html( crpcrm_display_value( $customer['last_content'] ) ); ?></dd><dt><?php echo esc_html( 'کلمه کلیدی' ); ?></dt><dd><?php echo esc_html( crpcrm_display_value( $customer['last_term'] ) ); ?></dd><dt><?php echo esc_html( 'صفحه ورود' ); ?></dt><dd><?php echo esc_html( crpcrm_display_value( $customer['last_landing_page'] ) ); ?></dd><dt><?php echo esc_html( 'ارجاع‌دهنده' ); ?></dt><dd><?php echo esc_html( crpcrm_display_value( $customer['last_referrer'] ) ); ?></dd><dt><?php echo esc_html( 'تاریخ آخرین ورود' ); ?></dt><dd><?php echo esc_html( crpcrm_display_value( $customer['last_seen_at'] ) ); ?></dd></dl></div>
		</div>
