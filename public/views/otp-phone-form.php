<div class="crpcrm-portal" dir="rtl">
	<div class="crpcrm-portal-card">
		...
		<h2><?php echo esc_html( 'ورود یا ثبت‌نام در پرتال' ); ?></h2>
		<p><?php echo esc_html( 'برای ورود به پرتال، شماره موبایل خود را وارد کنید.' ); ?></p>
		...
		<form method="post" action="<?php echo esc_url( $admin_post_url ); ?>" class="crpcrm-otp-form">
			...
			<label for="crpcrm_phone"><?php echo esc_html( 'شماره موبایل' ); ?></label>
